...
export const metadata: Metadata = {
  ...
  description: "Répondez à huit questions courtes pour obtenir une recommandation indicative : le type de profil adapté à votre salon et, en complément, un atelier de pratique.",
};
